# This code runs on a single computer and DOES NOT SUPPORT PARALLEL COMPUTING
# An explanation why this won't work in parallel is available in the README
# This will calculate the digits of pi for 120 seconds.
